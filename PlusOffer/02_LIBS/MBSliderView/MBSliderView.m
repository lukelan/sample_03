...
- (void) loadContent
{
    ...
    if (!_label || !_slider) {
        ...
        _imageViewBG = [[UIImageView alloc] initWithFrame:self.frame];
        [_imageViewBG setBackgroundColor:[UIColor clearColor]];
...
#pragma mark -
#pragma mark process action for control
...
#pragma mark -
#pragma mark set image for icon arrow, background Image
- (void) setBackgroundImage:(UIImage *)image
{
    [_imageViewBG setImage:image];
}
