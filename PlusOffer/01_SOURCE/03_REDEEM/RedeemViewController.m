...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    RedeemDetailViewController *redeemDetailViewController = [self.storyboard instantiateViewControllerWithIdentifier:@"redeemDetailViewController"];
    [self.navigationController pushViewController:redeemDetailViewController animated:NO];
}
