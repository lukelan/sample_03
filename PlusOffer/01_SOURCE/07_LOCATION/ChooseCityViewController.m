...
//    [self setCustomBarLeftWithImage:<#(UIImage *)#> selector:<#(SEL)#> context_id:<#(id)#>];
//    [self setCustomBarRightWithImage:<#(UIImage *)#> selector:<#(SEL)#> context_id:<#(id)#>];
    
    // add table
    [self.view addSubview:self.table];
    self.trackedViewName = CHOOSE_CITY_VIEW_NAME;
}
