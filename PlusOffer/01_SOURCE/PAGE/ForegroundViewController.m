    ...
    switch (gesture.state) {
        ...
        case UIGestureRecognizerStateEnded: {
            ...
            if (location.y >= self.view.center.y/2 && velocity.y > 0) {
                snapIt = [[UISnapBehavior alloc] initWithItem:self.view snapToPoint:CGPointMake(160, 786)];
            } else {
                snapIt = [[UISnapBehavior alloc] initWithItem:self.view snapToPoint:CGPointMake(160, 285)];
            }
